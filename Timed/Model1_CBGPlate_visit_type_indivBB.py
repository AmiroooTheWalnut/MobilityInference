    ...
    def run(self,numParticles,lr,elboType,alpha,i,retVals):
        ...
        def guide(data):
            ...
            with pyro.plate("G", data.G) as g:
                ...
                if elboType == 'RenyiELBO':
                    extraMessage = elboType + "_alpha" + str(alpha) + "_numParticle" + str(numParticles) + "_lr" + str(lr) + "_CBG_P_INDBB"
                else:
                    extraMessage = elboType + "_numParticle" + str(numParticles) + "_lr" + str(lr) + "_CBG_P_INDBB"
